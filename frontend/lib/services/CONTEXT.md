...
* **`gemini_service.dart`**: Wraps the Google Generative AI Dart SDK. Manages the **MindCare AI** companion sessions, handling history persistence and condition-specific system prompts.
