...
class _ResourcesScreenState extends State<ResourcesScreen> {
              ...
              Expanded(
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text('Resources', style: GoogleFonts.outfit(fontSize: 28, fontWeight: FontWeight.bold, color: AppColors.textPrimary)),
                      const SizedBox(height: 4),
                      Text('Educational content and support resources', style: GoogleFonts.outfit(fontSize: 14, color: AppColors.textSecondary)),
      ...
      child: Column(
        ...
        children: [
          Row(children: [
            ...
            Text('Crisis Support', style: GoogleFonts.outfit(fontSize: 18, fontWeight: FontWeight.bold, color: Colors.red.shade700)),
          ]),
          const SizedBox(height: 8),
          Text('If you\'re in crisis, please reach out immediately.', style: GoogleFonts.outfit(fontSize: 13, color: Colors.red.shade600)),
      ...
      child: GestureDetector(
        ...
        child: Container(
          ...
          child: Column(children: [
            ...
            Text(label, style: GoogleFonts.outfit(fontSize: 10, color: Colors.white70), textAlign: TextAlign.center),
          ]),
        ),
      ),
    );
  ...
  Widget _buildContentCard(ContentItem item, {bool isVideo = false}) {
    return Semantics(
      label: 'Open ${isVideo ? "video" : "article"} ${item.title}',
      button: true,
      child: GestureDetector(
        onTap: () {
          ...
          children: [
            ...
            Expanded(
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text(item.title, style: GoogleFonts.outfit(fontSize: 15, fontWeight: FontWeight.w600, color: AppColors.textPrimary)),
                  const SizedBox(height: 4),
                  Text(item.description, style: GoogleFonts.outfit(fontSize: 12, color: AppColors.textSecondary, height: 1.3), maxLines: 2, overflow: TextOverflow.ellipsis),
                ],
              ),
            ),
            const SizedBox(width: 8),
            Container(
              ...
              child: Text(item.duration, style: GoogleFonts.outfit(fontSize: 10, fontWeight: FontWeight.w600, color: AppColors.primaryPurple)),
            ),
          ],
        ),
      ),
  ...
  Widget _buildServiceDirectories() {
    final services = [
      {'title': 'Find a Therapist', 'desc': 'Psychology Today directory', 'url': 'https://www.psychologytoday.com/us/therapists'},
          ...
          child: GestureDetector(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(s['title']!, style: GoogleFonts.outfit(fontSize: 14, fontWeight: FontWeight.bold, color: AppColors.textPrimary)),
                const SizedBox(height: 4),
                Expanded(child: Text(s['desc']!, style: GoogleFonts.outfit(fontSize: 11, color: AppColors.textSecondary, height: 1.3), maxLines: 2, overflow: TextOverflow.ellipsis)),
              ],
            ),
          ),
        ),
  ...
  Widget _buildFeaturedContent() {
    final featured = [
      {'title': 'Understanding Therapy', 'colors': [const Color(0xFF7E57C2), const Color(0xFF512DA8)]},
      {'title': 'Self-Care Practices', 'colors': [const Color(0xFF66BB6A), const Color(0xFF388E3C)]},
    ];
        ...
        return Expanded(
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              borderRadius: BorderRadius.circular(20),
              boxShadow: [BoxShadow(color: colors.first.withValues(alpha: 0.2), blurRadius: 16, offset: const Offset(0, 4))],
            ),
            padding: const EdgeInsets.all(16),
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              ...
              children: [
                Text(f['title'] as String, style: GoogleFonts.outfit(fontSize: 16, fontWeight: FontWeight.bold, color: Colors.white)),
                const SizedBox(height: 12),
                Container(
                  ...
                  child: Text('Coming soon', style: GoogleFonts.outfit(fontSize: 11, fontWeight: FontWeight.w600, color: Colors.white)),
                )
              ],
            ),
          ),
